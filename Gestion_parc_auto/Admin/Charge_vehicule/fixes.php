        ...
        <div class=" row back_absolute rounded" >
            <div  style="margin-top:27px;">
                <div class="table_header rounded-top" style="background: linear-gradient(135deg,#333333,#f80000);">
                    <h3 style="color:#ffffff ">Charges fixes</h3>
                    <div> <!--<button class="add_new"><a style="color: white" href="http://localhost/Gestion_parc_auto/Admin/Charge_vehicule/facture.php">+ Add New</a></button>--> </div>
                </div>
                <div class="table_section " style="background-color: white;">
                    <table>
                        ...
                        <?php
                        require("db.php");
                        $stm = $con->prepare("SELECT f.*,immatriculation FROM facture f,vehicule v WHERE v.id_vehicule=f.id_vehicule and f.numcharge=1;");
                        $stm->execute();
                        $l=$stm->fetchAll();
