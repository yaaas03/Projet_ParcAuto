        ...
        <div class=" row back_absolute rounded" >
            <div  style="margin-top:27px;">
                <div class="table_header rounded-top" style="background: linear-gradient(135deg,#333333,#f80000);">
                    <h3 style="color:#ffffff ">Procès</h3>
                    <div> <input  id="live_search" style="background-color:#ffffff" placeholder="Recherche par matricule"  /> <button class="add_new"><a style="color: white" href="http://localhost/Gestion_parc_auto/Admin/Proce/ajouterproce.php">+ Add New</a></button> </div>
                </div>
                <div class="table_section " style="background-color: white;">
                    <table>
                        ...
                        <tr>
                            ...
                            <th>Montant</th>
                            <th style="width:157px">Date paiement</th>
                            <th>collaborateur</th>
                            <th>Action</th>
                        </tr>
                        </thead>
                        ...
                        <?php
                        require("db.php");
                        $stm = $con->prepare("select p.* , pr.nom , pr.prenom  FROM personne pr, proces p where pr.id_personne=p.id_personne order by date_paiement");
                        $stm->execute();
                        $l=$stm->fetchAll();
                        foreach ($l as $ligne){
                            ...
                            echo '<td> <button><a  href="payement.php?id='.$ligne["numproces"].'"><i class="bx bx-check table_icon"></i></a></button> <button><a  href="modifier.php?id='.$ligne["numproces"].'"><i class="bx bx-edit-alt table_icon"></i></a></button> <button style="background-color: #8493a5;"><a href="supprimer.php?id='.$ligne["numproces"].'"><i class="bx bx-trash table_icon" ></i></a></button> </td>';
                            echo "</tr>";
                        }
