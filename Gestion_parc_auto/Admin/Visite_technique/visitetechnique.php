        ...
        <div class=" row back_absolute rounded" >
            <div  style="margin-top:27px;">
                <div class="table_header rounded-top" style="background: linear-gradient(135deg,#333333,#f80000);">
                    <h3 style="color:#ffffff ">Visites techniques</h3>
                    <div> <input id="live_search"  style="background-color:#ffffff" placeholder="Recherche par matricule"  /> <button class="add_new"><a style="color: white" href="http://localhost/Gestion_parc_auto/Admin/Visite_technique/ajoutervisite.php">+ Add New</a></button> </div>
                </div>
                <div class="table_section " style="background-color: white;">
                    <table>
                        <thead >
                        <tr>
                            <th style="width:240px">N°visite</th>
                            <th style="width:200px">nature_visite</th>
                            <th>Montant</th>
                            <th style="width:157px">Date visite</th>
                            <th>Matricule</th>
                            <th>Action</th>
                        </tr>
                        </thead>
                        ...
                        <?php
                        require("db.php");
                        $stm=$con->prepare("select vt.*,immatriculation  FROM  visite_technique vt inner join vehicule v where v.id_vehicule=vt.id_vehicule order by date_visite");
                        $stm->execute();
                        $l=$stm->fetchAll();
                        foreach ($l as $ligne){
