...
<header class="header">
    <div class="header__container">
        <img src="../../media/logo-sofa.png" alt="" class="header__img">

        <a href="#" class="header__logo">SOFA Maroc</a>
        ...
        <div class=" row back_absolute rounded" >
            <div  style="margin-top:27px;">
                <div class="table_header rounded-top" style="background: linear-gradient(135deg,#333333,#f80000);">
                    <h3 style="color:#ffffff ">Historique  affectation d'une vehicule</h3>
                    <div>  </div>
                </div>
                <div class="table_section " style="background-color: white;">
                    <?php
                    require("db.php");
                    $stm = $con->prepare("SELECT v.immatriculation,p.nom,p.prenom,av.date_affectation,av.date_recuperation FROM historique h,vehicule v,affectation_vehicule av,personne p WHERE V.id_vehicule=h.id_vehicule and h.id_vehicule=:id and av.id_affectation=h.id_affectation and p.id_personne=h.id_personne");
